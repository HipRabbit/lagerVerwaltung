...
public interface IStorage {
	...
	void addNachbestellung(Nachbestellung model);
	void updateNachbestellungStatus(int id, String status);
	void confirmNachbestellung(int id, int menge);
	List<Nachbestellung> getNachbestellungen();


	void initNachbestellung(List<Nachbestellung> list);

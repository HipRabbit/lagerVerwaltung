...
public class LagerPlatzPage extends JPanel {
    ...
    private void initializeUI() {
        ...
        idField.setToolTipText("Geben Sie die Lagerplatz-ID ein");
        ...
        btnSearch.addActionListener(e -> {
            try {
                ...
                if (lagerplatz != null && lagerplatz.getId() > 0) { // Überprüfe, ob ein gültiges Lager zurückgegeben wurde
                    ...
                    tableModel.setSingleLagerPlatz(null);
                }
...
class LagerPlatzTableModel extends javax.swing.table.AbstractTableModel {
    ...
    public void sortByCapacity(boolean ascending) {
        Comparator<LagerPlatz> comparator = Comparator.comparing(LagerPlatz::getKapazitaet);
        if (!ascending) comparator = comparator.reversed();
        Collections.sort(data, comparator);
        fireTableDataChanged();
    }

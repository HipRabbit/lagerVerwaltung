...
public class LagerPage extends JPanel {
    ...
    private void initializeUI() {
        ...
        idField.setToolTipText("Geben Sie die Lager-ID ein");
        ...
        // Sortierbuttons (unterhalb der Suche)
        ...
        btnSearch.addActionListener(e -> {
            try {
                ...
                if (lager != null && lager.getId() > 0) { // Überprüfe, ob ein gültiges Lager zurückgegeben wurde
                    tableModel.setSingleLager(lager);
                } else {
                    JOptionPane.showMessageDialog(this, "Lager mit ID " + id + " nicht gefunden!", "Hinweis", JOptionPane.INFORMATION_MESSAGE);
                    tableModel.setSingleLager(null);
                }
